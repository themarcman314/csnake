char const *country_codes[] = {
    "AD", "AE",	    "AF",     "AG",    "AI",	"AL", "AM",	"AO",
    "AQ", "ARAB",   "AR",     "ASEAN", "AS",	"AT", "AU",	"AW",
    "AX", "AZ",	    "BA",     "BB",    "BD",	"BE", "BF",	"BG",
    "BH", "BI",	    "BJ",     "BL",    "BM",	"BN", "BO",	"BQ",
    "BR", "BS",	    "BT",     "BV",    "BW",	"BY", "BZ",	"CA",
    "CC", "CD",	    "CEFTA",  "CF",    "CG",	"CH", "CI",	"CK",
    "CL", "CM",	    "CN",     "CO",    "CP",	"CR", "CU",	"CV",
    "CW", "CX",	    "CY",     "CZ",    "DE",	"DG", "DJ",	"DK",
    "DM", "DO",	    "DZ",     "EAC",   "EC",	"EE", "EG",	"EH",
    "ER", "ES-CT",  "ES-GA",  "ES",    "ES-PV", "ET", "EU",	"FI",
    "FJ", "FK",	    "FM",     "FO",    "FR",	"GA", "GB-ENG", "GB-NIR",
    "GB", "GB-SCT", "GB-WLS", "GD",    "GE",	"GF", "GG",	"GH",
    "GI", "GL",	    "GM",     "GN",    "GP",	"GQ", "GR",	"GS",
    "GT", "GU",	    "GW",     "GY",    "HK",	"HM", "HN",	"HR",
    "HT", "HU",	    "IC",     "ID",    "IE",	"IL", "IM",	"IN",
    ...
    "SA", "SB",	    "SC",     "SD",    "SE",	"SG", "SH-AC",	"SH-HL",
    "SH", "SH-TA",  "SI",     "SJ",    "SK",	"SL", "SM",	"SN",
